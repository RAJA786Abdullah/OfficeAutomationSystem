...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Document Types</h2>
    ...
    <div class="card">
        <div class="card-header">
            ...
            @can('document_type_create')
                <a href="{{route('document_types.create')}}" class="btn btn-primary ml-auto">
                    <i class="fa fa-plus"></i>&ensp;Add Document type
                </a>
            @endcan
        </div>
        <div class="card-body">
                ...
                <table class="table mb-0 table-sm table-striped text-nowrap w-100 display">
                    ...
                    @foreach($documentTypes as $documentType)
                        <tr>
                            ...
                            <td>{{$documentType->department->name}}</td>
                            <td>{{date('d-m-Y', strtotime($documentType->created_at))}}</td>
                            <td>
                                @php
                                    $crud = 'document_types';
                                    $row = $documentType->id;
