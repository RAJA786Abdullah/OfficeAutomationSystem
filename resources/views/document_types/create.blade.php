...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Add Document Type</h2>
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('document_types.index')}}">Document Types</a>
                        </li>
                        <li class="breadcrumb-item active">Add Document Type
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="row g-2 align-items-center">
                    <div class="col-12">
                        ...
                        <input type="text" name="name" class="form-control form-control-lg @error('name') is-invalid @enderror" placeholder="{{ __('Name') }}" value="{{ old('name')}}" autofocus required>
                    </div>
                    @if($errors->has('name'))
                    ...
                    <div class="col-12">
                        ...
                        <input type="number" name="code" class="form-control form-control-lg @error('code') is-invalid @enderror" placeholder="{{ __('Code') }}" value="{{ old('code')}}" required>
                    </div>
                    @if($errors->has('code'))
                        <div class="text-danger">
                            {{ $errors->first('code') }}
