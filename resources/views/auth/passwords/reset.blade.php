                        ...
                        <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                            ...
                            <form class="auth-login-form mt-2" action="{{ route('password.update') }}" method="POST">
                                ...
                                <div class="mb-1">
                                    ...
                                    <input class="form-control @error('email') is-invalid @enderror" id="login-email" type="text" name="email" value="{{ $email ?? old('email') }}" placeholder="john@example.com" aria-describedby="login-email" autofocus="" tabindex="1" required autocomplete="email"/>
                                    @error('email')
