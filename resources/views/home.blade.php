        ...
        <div class="row justify-content-center mb-2">
            <div class="col-md-3 col-sm-6 mb-2">
                <div class="bg-gradient-primary custom-col shadow-bottom border-1 dashboard-widgets text-center">
                    <div class="pt-1 pb-1 font-weight-bold">Not Approved: {{$notApprovedDocs}}</div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 mb-2">
                <div class="bg-gradient-primary custom-col shadow-bottom border-1 dashboard-widgets text-center">
                    <div class="pt-1 pb-1 font-weight-bold">Received: {{ $received }}</div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 mb-2">
                <div class="bg-gradient-primary custom-col shadow-bottom border-1 dashboard-widgets text-center">
                    <div class="pt-1 pb-1 font-weight-bold">Sent: {{$sent}}</div>
                </div>
            </div>
        </div>
    </div>
