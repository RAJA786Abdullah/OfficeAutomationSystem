            ...
            <div class="card-body">
                ...
                <div class="row g-2 align-items-center">
                    <div class="col-12">
                        ...
                        <input type="text" name="name" class="form-control form-control-lg @error('name') is-invalid @enderror" placeholder="{{ __('Regional Office Name') }}" value="{{ old('name')}}" autofocus required />
                    </div>
                    @if($errors->has('name'))
