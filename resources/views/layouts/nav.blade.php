...
@section('nav')
    <!-- BEGIN: Header-->
    <nav class="header-navbar navbar navbar-expand-lg align-items-center floating-nav navbar-light navbar-shadow container-fluid content-body">
...
{{--                            </li>--}}
                        ...
                        <p class="position-fixed bottom-0 ms-3">Version 1.2</p>
                    </li>
                @endcan
            </ul>
        </div>
