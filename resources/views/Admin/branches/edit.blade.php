                ...
                <div class="row g-2 align-items-center">
                    <div class="col-12">
                        ...
                        <input type="text" name="name"
                               ...
                               placeholder="{{ __('Document Name') }}" value="{{ $branch->name,old('name')}}"/>
                    </div>
                    @if($errors->has('name'))
                    ...
                    <div class="col-12">
                        ...
                        <select name="location" id="location"
                            ...
                            <option value="islamabad" @if($branch->location == 'islamabad') selected @endif>Islamabad
                            </option>
                            <option value="karachi" @if($branch->location == 'karachi') selected @endif>Karachi</option>
                            <option value="peshawar" @if($branch->location == 'peshawar') selected @endif>Peshawar
                            </option>
