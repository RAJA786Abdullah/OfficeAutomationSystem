@extends('layouts.nav')
@section('title', 'Classification Edit')
...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Edit Classification</h2>
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('classifications.index')}}">Classifications</a>
                        </li>
                        <li class="breadcrumb-item active">Edit Classification
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row g-2 align-items-center">
                    <div class="col-12">
                        ...
                        <input type="text" name="name" class="form-control form-control-lg @error('name') is-invalid @enderror" placeholder="{{ __('Name') }}" value="{{ $classification->name,old('name')}}" required>
                    </div>
                    @if($errors->has('name'))
