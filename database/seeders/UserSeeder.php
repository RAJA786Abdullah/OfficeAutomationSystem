...
class UserSeeder extends Seeder
{
    public function run()
    {
        $aryUsers = [
            ...
            ['userID' => '6','name' => 'Kashif','email' => 'kashif','lastLogin' => NULL,'status' => '1','lastLoginIP' => NULL,'password' => \Illuminate\Support\Facades\Hash::make('admin123'),'department_id' => '2','branch_id' => '1','is_signing_authority' => '1','arm_designation' => 'civil'],
            ['userID' => '7','name' => 'Khuram','email' => 'khuram','lastLogin' => NULL,'status' => '1','lastLoginIP' => NULL,'password' => \Illuminate\Support\Facades\Hash::make('admin123'),'department_id' => '2','branch_id' => '1','is_signing_authority' => '1','arm_designation' => 'civil'],
            ['userID' => '8','name' => 'Wahab','email' => 'wahab','lastLogin' => NULL,'status' => '1','lastLoginIP' => NULL,'password' => \Illuminate\Support\Facades\Hash::make('admin123'),'department_id' => '2','branch_id' => '1','is_signing_authority' => '0','arm_designation' => 'civil'],
            ['userID' => '9','name' => 'Rahim','email' => 'rahim','lastLogin' => NULL,'status' => '1','lastLoginIP' => NULL,'password' => \Illuminate\Support\Facades\Hash::make('admin123'),'department_id' => '2','branch_id' => '1','is_signing_authority' => '0','arm_designation' => 'civil']
        ];
