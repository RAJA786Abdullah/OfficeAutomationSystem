...
class UserSeeder extends Seeder
{
    public function run()
    {
        ...
        $aryUsers = [
            ...
            ['userID' => '2','name' => 'Hameed','email' => 'hameed','lastLogin' => NULL,'status' => '1','lastLoginIP' => NULL,'password' => '$2y$10$Bh51gNJB0h2/B6k/Wyg5R.F/fsQPSKVTv3r/4UVjxwjWpTznMfG7O','department_id' => '1','branch_id' => '1','is_signing_authority' => '1','arm_designation' => 'Lt Col (Ret]'],
            ['userID' => '3','name' => 'Adnan','email' => 'adnan','lastLogin' => NULL,'status' => '1','lastLoginIP' => NULL,'password' => '$2y$10$mrRwyKT5ajAnYAw4T4FFdeXNh3RzQOxE76z792UlUu4s4s.mnWSya','department_id' => '1','branch_id' => '1','is_signing_authority' => '1','arm_designation' => 'civil'],
            ...
            ['userID' => '5','name' => 'Omar Khan','email' => 'omarkhan','lastLogin' => NULL,'status' => '1','lastLoginIP' => NULL,'password' => '$2y$10$y/wYvzhGPHwa1FSp2opedep3GK/nJkzTYHy8K9NS688NhEBX.1bJW','department_id' => '1','branch_id' => '1','is_signing_authority' => '0','arm_designation' => 'civil'],
